    ...
    <footer className="pt-24">
      <div className="px-24 pb-4 xs:px-6">
        <div className="flex items-center mb-12">
          <span className="hidden border border-solid border-primary mx-12 flex-grow xs:block xs:mx-0 xs:mr-8"></span>
          <span className="font-serif font-semibold text-gray-800 text-3xl text-center xs:text-xl">
            {t("siteMetadata.title")}
          </span>
          <span className="border border-solid border-primary mx-12 flex-grow xs:mx-0 xs:ml-8"></span>
